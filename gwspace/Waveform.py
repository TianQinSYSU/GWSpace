...
class RingdownWaveform(BasicWaveform):
    """ Waveform for Ringdown Analysis. The waveform from function get_hphc() is generated by Spline of the original
    waveform, so that could be used for time domain response calculation. The default waveform in this class is
    IMRPhenomXHM. You need to install lalsimulation and lal module before using this class.
    ...
    :param chi1: Spin of the primary black hole (-1, 1)
    :param chi2: Spin of the secondary black hole (-1, 1)
    :param modes: Gravitational waveform modes need to be set like [(2, 2), (3, 3)]. You can set other modes here.
