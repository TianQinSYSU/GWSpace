...
class GCBWaveform(BasicWaveform):
    ...
    def __init__(self, mass1, mass2, T_obs, DL, phi0, f0, 
            fdot=None, fddot=None, **kwargs):
        super.__init__(self, mass1, mass2, T_obs, DL, **kwargs)
...
class FastGB(GCBWaveform):
    ...
    def __init__(self, mass1, mass2, T_obs, DL, phi0, f0, 
            fdot=None, fddot=None,**kwargs):
        super().__init__(mass1, mass2, T_obs, DL, phi0, f0,
                fdot, fddot, **kwargs)
        self.N = N
